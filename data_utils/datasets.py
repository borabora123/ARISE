...
def initialize_data(cfg):
    print(cfg.train_dataset.img_dir)
    print(cfg.val_dataset.img_dir)
    train_dataset = ImageClassificationDataset(cfg.train_dataset.img_dir, instantiate(cfg.train_dataset.transform))
    val_dataset = ImageClassificationDataset(cfg.val_dataset.img_dir, instantiate(cfg.val_dataset.transform))
