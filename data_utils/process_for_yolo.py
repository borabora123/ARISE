...
if __name__ == "__main__":
    with open('C:\\Users\\User\\PycharmProjects\\ARISE\\dataset\\train_val_split.json', "r") as f:
        subsets = json.load(f)
    # Load the data
    data = pd.read_csv('C:\\Users\\User\\PycharmProjects\\ARISE\\dataset\\merges_box_scores.csv')

    # Run preprocessing
    main(data, 'C:\\Users\\User\\PycharmProjects\\ARISE\\dataset\\jpeg', 'C:\\Users\\User\\PycharmProjects\\ARISE\\data', subsets)
